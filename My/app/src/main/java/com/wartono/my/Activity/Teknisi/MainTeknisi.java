...
import com.wartono.my.Adapter.adapter_data_teknisi;
...
public class MainTeknisi extends AppCompatActivity {
    ...
    public void ambil_data() {
        ...
        tampil_data.enqueue(new Callback<ResponseData>() {
            ...
            public void onResponse(Call<ResponseData> call, Response<ResponseData> response) {
                ...
                adapter = new adapter_data_teknisi(MainTeknisi.this, list);
    ...
    public void onBackPressed() {
        androidx.appcompat.app.AlertDialog dialog = new androidx.appcompat.app.AlertDialog.Builder(MainTeknisi.this)
                ...
                .setPositiveButton("Ya", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        Intent i = new Intent(MainTeknisi.this, LoginActivity.class);
                        startActivity(i);
                        finish();
                    }
                })
